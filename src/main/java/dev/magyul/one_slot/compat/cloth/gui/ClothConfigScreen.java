package dev.magyul.one_slot.compat.cloth.gui;
...
public class ClothConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.message = MultilineText.create(this.textRenderer, Text.translatable("gui.one_slot.cloth_config_warning.message"), 300);
        this.addDrawableChild(
                ButtonWidget.builder(Text.translatable("gui.one_slot.cloth_config_warning.download"), b -> openUrl(CLOTH_CONFIG_URL))
